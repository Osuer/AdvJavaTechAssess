...
public class HandTest {
    ...
    //This deck object is used to force hand outcomes and test specific hand outcomes.
    Deck unshuffledDeck;
    ...
    public void TestHandForStraightFlush(){
        ...
        assertEquals("Straight Flush", myHand.evaluateHand() );
    }
    ...
    public void TestHandForFourOfAKind(){
        ...
        Hand myHand = new Hand(forcedHand);
        assertEquals("Four of a Kind", myHand.evaluateHand() );
    }
    ...
    public void TestHandForFullHouse(){
        ...
        Hand myHand = new Hand(forcedHand);
        assertEquals("Full House", myHand.evaluateHand() );
    }
    ...
    public void TestHandForFlush(){
        ...
        Hand myHand = new Hand(forcedHand);
        assertEquals("Flush", myHand.evaluateHand() );
    }
    @Test
    public void TestHandForStraight(){
        ...
        Hand myHand = new Hand(forcedHand);
        assertEquals("Straight", myHand.evaluateHand() );
    }
    ...
    public void TestHandForThreeOfAKind(){
        ...
        Hand myHand = new Hand(forcedHand);
        assertEquals("Three of a Kind", myHand.evaluateHand() );
    }
    ...
    public void TestHandForTwoPair(){
        ...
        forcedHand.add(unshuffledDeck.getCard(50)); // King Of Spades
        Hand myHand = new Hand(forcedHand);
        assertEquals("Two Pair", myHand.evaluateHand() );
    }
    ...
    public void TestHandForOnePair(){
        ...
        forcedHand.add(unshuffledDeck.getCard(50)); // King Of Spades
        Hand myHand = new Hand(forcedHand);
        assertEquals("One Pair", myHand.evaluateHand() );
    }
    ...
    public void TestHandForHighCards(){
        ...
        forcedHand.add(unshuffledDeck.getCard(50)); // King Of Spades
        Hand myHand = new Hand(forcedHand);
        assertEquals("High Cards", myHand.evaluateHand() );
    }
